package com.bvc.ordering.view.paylist
...
import com.bvc.ordering.databinding.FragmentPayListBinding
...
@AndroidEntryPoint
class PayFragment : BaseFragment<FragmentPayListBinding>() {
    override val layoutResourceId: Int
        get() = R.layout.fragment_pay_list
    private val viewModel: PayListViewModel by viewModels()
