...
import com.bvc.ordering.databinding.ItemBotCategoryBinding

class SubCategoryAdapter<T : Any>(
    private val itemClickListener: OnItemClickListener<T>,
) : ListAdapter<T, SubCategoryAdapter.DefaultViewHolder<T>>(DiffCallback<T>()) {
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            ItemBotCategoryBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class DefaultViewHolder<T>(
        private val binding: ItemBotCategoryBinding,
