...
class SplashActivity : BaseActivity() {
    ...
    val startForResultForTelegram = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result: ActivityResult ->
...
//                    tv.text = str
            ...
            } else Toast.makeText(this, "앱 호출 실패", Toast.LENGTH_LONG).show()
        }
