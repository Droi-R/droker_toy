...
object Telegram {
    ...
    fun makeTelegramIC(
        ...
        if (apprCode == "1") bb.put("0200".toByteArray()) // 전문구분
        else if (apprCode == "0") bb.put("0420".toByteArray()) // 전문구분
...
//        mTotAmt = KsnetUtil.stringToAmount(totAmt, 12)
        ...
        bb.put(
            KsnetUtil.stringToAmount(java.lang.String.valueOf(tax.getServiceAmt()), 12)
                .toByteArray()
        ) // 봉사료
        bb.put(
...
//        mSupAmt = KsnetUtil.stringToAmount(java.lang.String.valueOf(tax.getSupplyAmt()), 12)
        bb.put("000000000000".toByteArray()) // 면세금액
